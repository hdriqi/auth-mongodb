const confirmLoginEmailTemplate = (link) => {
  return `
  <heml>
  <head>
  ...
  <body>
    <container>
      ...
      <row style="margin-bottom: 8px">
        <p>Hi there,</p>
        <p>We received a request to reset password from your Vestrade account. If this is correct, please confirm by clicking the button below</p>
      </row>
      <button style="margin-bottom: 36px" href="${link}">Reset Password</button>
      <row>
...
module.exports = confirmLoginEmailTemplate